...
const ReportsReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "GET_REPORTS_REDUCER":
      return {
        ...state,
        getReportsList: action.payload.response,
        getSuccessReports: action.payload.statusCode,
      };
    ...
    case "GET_REPORTS_INVOICE_REGISTER_REDUCER":
      return {
        ...state,
        getInvoiceRegister: action.payload.response,
        getInvoiceRegisterSuccess: action.payload.statusCode,
      };
    ...
    case "GET_REPORTS_EXPENSE_REGISTER_REDUCER":
      return {
        ...state,
        getExpenseRegister: action.payload.response,
        getExpenseRegisterSuccess: action.payload.statusCode,
      };
    ...
    case "GET_REPORTS_RECEIPT_REGISTER_REDUCER":
      return {
        ...state,
        getReceiptRegister: action.payload.response,
        getReceiptRegisterSuccess: action.payload.statusCode,
      };
    ...
    case "GET_REPORTS_TENANT_REGISTER_REDUCER":
      return {
        ...state,
        getTenantRegister: action.payload.response,
        getTenantRegisterSuccess: action.payload.statusCode,
      };
    ...
    case "REPORTS_TENANT_REGISTER_PDF_REDUCER":
      return {
        ...state,
        reportsTenantsPdf: action.payload.response,
        reportsTenantsPdfSuccess: action.payload.statusCode,
      };
    ...
    case "REPORTS_RECEIPT_REGISTER_PDF_REDUCER":
      return {
        ...state,
        reportsReceiptPdf: action.payload.response,
        reportsReceiptPdfSuccess: action.payload.statusCode,
      };
    ...
    case "REPORTS_INVOICE_REGISTER_PDF_REDUCER":
      return {
        ...state,
        reportsInvoicePdf: action.payload.response,
        reportsInvoicePdfSuccess: action.payload.statusCode,
      };
    ...
    case "REPORTS_EXPENSE_REGISTER_PDF_REDUCER":
      return {
        ...state,
        reportsExpensePdf: action.payload.response,
        reportsExpensePdfSuccess: action.payload.statusCode,
      };

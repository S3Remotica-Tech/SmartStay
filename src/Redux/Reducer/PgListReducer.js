...
const PgListReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "GET_DASHBOARD_REDUCER":
      return {
        ...state,
        dashboardList: action.payload.response,
        getDashboardSuccessStatus: action.payload.statusCode,
      };
    ...
    case "DELETE_ANNOUNCEMENT":
      return {
        ...state,
        deleteAnnounmentSuccessStatus: action.payload.statusCode,
      };
    ...
    case "GET_ALL_ROOMS":
      return {
        ...state,
        roomsList: action.payload.response,
        getAllRoomSuccessStatus: action.payload.statusCode,
      };
    ...
    case "GET_COMMENTS":
      return {
        ...state,
        CommentsList: action.payload.response,
        getCommentsSuccessStatus: action.payload.statusCode,
      };
    ...
    case "CREATE_SUB_COMMENTS":
      return {
        ...state,
        addSubCommentsSuccessStatus: action.payload.statusCode,
      };
    ...
    case "DELETE_HOSTEL_IMAGES":
      return {
        ...state,
        dleteHostelImagesStatusCode: action.payload.statusCode,
      };
    ...
    case "OCCUPIED_CUSTOMER":
      return {
        ...state,
        OccupiedCustomer: action.payload.response,
        OccupiedCustomerGetStatusCode: action.payload.statusCode,
      };
    ...
    case "CREATE_PG":
      return {
        ...
        createPgStatusCode: action.payload.statusCode,
      };
    ...
    case "CREATE_ROOM":
      return {
        ...
        floor_Id: action.payload.floorId,
        room_Id: action.payload.roomId,
        number_Of_Bed: action.payload.number_of_beds,
        statusCodeCreateRoom: action.payload.statusCode,
      };
    ...
    case "CREATE_EB":
      return {
        ...state,
        createEBList: action.payload.response,
        AddEBstatusCode: action.payload.statusCode,
      };
    case "CLEAR_EB":
    ...
    case "EB_STARTMETER_LIST":
      return {
        ...state,
        EB_startmeterlist: action.payload.response,
        statusCodeForEbRoomList: action.payload.statusCode,
      };
    ...
    case "NO_ROOM_BASED":
      return {
        ...state,
        statusCodeForEBRoombasednodata: action.payload.statusCode,
      };
    ...
    case "EB_CUSTOMER_EBLIST":
      return {
        ...state,
        EB_customerTable: action.payload.response,
        statusCodeforEbCustomer: action.payload.statusCode,
      };
    ...
    case "NO_EB_HOSTEL_BASED":
      return {
        ...state,
        nostatusCodeforEbHostelBased: action.payload.statusCode,
      };
    ...
    case "CREATE_PG_DASHBOARD":
      return {
        ...state,
        dashboardDetails: action.payload.response,
        statuscodeForDashboard: action.payload.statusCode,
      };
    ...
    case "ROOM_COUNT":
      return {
        ...state,
        roomCount: action.payload.response,
        roomCountStatusCode: action.payload.statusCode,
      };
    case "NO_ROOMS":
    ...
    case "UPDATE_FLOOR":
      return {
        ...state,
        updateFloorSuccessStatusCode: action.payload.statusCode,
      };
    ...
    case "SAME_TITLE":
      return {
        ...state,
        TitleAlready: action.payload.response,
        SameTitleErrorStatusCode: action.payload.statusCode,
      };
    ...
    case "TITTLE_UNIQUE":
      return {
        ...state,
        TittleUnique: action.payload.response,
        SameTitleErrorStatusCode: action.payload.statusCode,
      };

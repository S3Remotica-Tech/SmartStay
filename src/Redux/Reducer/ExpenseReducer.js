...
const ExpenseReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "INITIALIZE_EXPENSES_LIST":
      return {
        ...state,
        getInitializeExpenseList: action.payload.response,
        getInitializeExpenseStatusCode: action.payload.statusCode,
      };
    ...
    case "UNITS_LIST_REDUCER":
      return { ...state, unitList: action.payload.response };
    ...
    case "ADD_EXPENSE":
      return {
        ...state,
        StatusCodeForAddExpenseSuccess: action.payload.statusCode,
      };
    ...
    case "UPDATE_EXPENSE_REDUCER":
      return {
        ...state,
        StatusCodeForUpdateExpenseSuccess: action.payload.statusCode,
      };
    ...
    case "EXPENSES_LIST":
      return {
        ...state,
        expenseList: action.payload.response,
        paymentModeList: action.payload.paymentmode,
    ...
    case "NOEXPENSEDATA":
      return {
        ...state,
        nodataGetExpenseStatusCode: action.payload.statusCode,
      };
    ...
    case "ADD_EXPENSE_TAG":
      return {
        ...state,
        StatusCodeForAddExpenseTagSuccess: action.payload.statusCode,
      };

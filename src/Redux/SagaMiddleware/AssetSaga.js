...
function* handleGetAllVendorList(action) {
  try {
    const response = yield call(GetAllVendorList, action.payload);
...
function* AssetSaga() {
  yield takeEvery("ALL_VENDOR_LIST_SAGA", handleGetAllVendorList);

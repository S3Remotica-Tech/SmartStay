...
function Logout({ show, handleClose }) {
  ...
  const [logoutAdminLoading, setLogoutAdminLoading] = useState(false);
  ...
  return (
    ...
    !justify-center
    !gap-2
    ${logoutAdminLoading ? "!opacity-70 !cursor-not-allowed" : ""}
  `}

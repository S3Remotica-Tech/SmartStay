...
<h5 style={{ fontSize: 56, color: "rgba(34, 34, 34, 1)", fontWeight: 700, fontFamily:"'Gilroy',sans-serif",textAlign:"center"}}> Key <span style={{ fontSize: 56, color: "rgba(30, 69, 225, 1)", fontWeight: 700, fontFamily:"'Gilroy',sans-serif" }} >Features </span></h5>

</div>
         
            {keyValue.map((item)=>(
           <div className='col-lg-4 col-md-6 col-xs-12 col-sm-12'>
    <Card style={{backgroundColor:"rgba(224, 236, 255, 1)",borderRadius:24,border:"1px solid rgba(224, 236, 255, 1)"}}>
      <Card.Body>

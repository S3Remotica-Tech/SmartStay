...
describe('it should check settings reducers', () => {
  ...
  SettingsBilltemplategetErrorCode : 0,
        ...
        const result = SettingsReducer(modifyState, action);
...
it('it should check DELETE_GENERAL_ERROR', () => {
        const action = {
            type: 'DELETE_GENERAL_ERROR',
            payload: "general error"
        };
        ...
        expect(SettingsReducer(initialState, action)).toStrictEqual({
            ...
            roleError: '',
            roleEditError: '',
            generalDeleteError: 'general error',
            subscriptionNew: [],
            statusCodeNewSubscription: 0,
            subcripitionAllDetails: [],
            statusCodeForSubcripitionAllDetails: 0,
...
it('it should check CLEAR_DELETE_GENERAL_ERROR', () => {
        const action = {
            type: 'CLEAR_DELETE_GENERAL_ERROR',
            payload: ""
        };
...
it('it should check SUBSCRIPTION_PDF', () => {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
       Expences: [],
            ...
            statusCodeForSubcripitionAllDetails: 0,
            toTriggerPDF: false,
            SubscriptionPDF: [{ name: 'sample.pdf' }],
...
it('it should check  CLEAR_SUBSCRIPTION_PDF_STATUS_CODE', () => {
  const action = {
...
it('it should check CLEAR_SETTINGSADDRECURRING_STATUS_CODE', () => {
  const action = {
...
it('it should check CLEAR_FREQUENCYTYPESLIST_STATUS_CODE', () => {
  const action = {
...
it('it should check NOTIFICATIONTYPESLIST', () => {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        planExpired: '',
        FrequencyTypeList: [],
        NotificationTypeList: ['Email', 'SMS', 'Push'],
        FrequncyTypegetSuccessCode: 0,
...
it('it should check CLEAR_NOTIFICATIONTYPESLIST_STATUS_CODE', () => {
  const action = {
...
it('it should check SETTINGSGETRECURRING', () => {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        FrequncyTypegetSuccessCode: 0,
        NotificationypegetSuccessCode: 0,
        SettingsBillsGetRecurring: ['Water', 'Maintenance'],
        SettingsInvoice: [],
        SettingsRecurringAddSuccess: 0,
        settingsAddInvoiceSucesscode: 0,
...
it('it should check CLEAR_SETTINGSGETRECURRING_STATUS_CODE', () => {
  const action = {
...
it('it should check CLEAR_ADDINVOICE_SETTINGS_STATUS_CODE', () => {
  const action = {
...
it('it should check SETTINGSGETINVOICE', () => {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        NotificationypegetSuccessCode: 0,
        SettingsBillsGetRecurring: [],
        SettingsInvoice: ['Invoice1', 'Invoice2'],
        SettingsRecurringAddSuccess: 0,
        settingsAddInvoiceSucesscode: 0,
        settingsBillsggetRecurrSucesscode: 0,
        settingsInvoicegetErrorStatuscode: 0,
...
it('it should check CLEAR_SETTINGSGETINVOICE_STATUS_CODE', () => {
  const action = {
...
it('it should check ERROR_SETTINGS_GETINVOICE', () => {
  const action = {
    type: 'ERROR_SETTINGS_GETINVOICE',
    payload: {
      statusCode: 500
    }
  };
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
    ...
    settingsAddInvoiceSucesscode: 0,
    settingsBillsggetRecurrSucesscode: 0,
    settingsInvoicegetErrorStatuscode: 500,
    settingsInvoicegetSucesscode: 0,
     settingGlobalAddStatusCode:0,
    FetchGlobal: [],
  statusCodeForSettingFetch: 0,
...
it('it should check CLEAR_ERROR_SETTINGS_GETINVOICE_STATUS_CODE', () => {
  const action = {
    type: 'CLEAR_ERROR_SETTINGS_GETINVOICE_STATUS_CODE'
  };
...
it('it should check PLAN-EXPIRED', () => {
  const action = {
    type: 'PLAN-EXPIRED',
    payload: 'Plan expired on 31-Dec-2025'
  };
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
    ...
    SubscriptionPDF: [],
    SubscriptionPdfSuccess: 0,
    planExpired: 'Plan expired on 31-Dec-2025',
    FrequencyTypeList: [],
    NotificationTypeList: [],
    FrequncyTypegetSuccessCode: 0,
    NotificationypegetSuccessCode: 0,
...
it('it should check ADD_GLOBAL_SETTINGS', () => {
  const action = {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        settingsInvoicegetErrorStatuscode: 0,
        settingsInvoicegetSucesscode: 0,
         settingGlobalAddStatusCode:200,
    FetchGlobal: [],
  statusCodeForSettingFetch: 0,
  settingsBillsAddTemplateSucesscode: 200,
  settingsBillsTemplateList : [],
  SettingsBilltemplategetsuccessCode : 0,
  SettingsBilltemplategetErrorCode : 0,
  });
...
it('it should check CLEAR_ADD_GLOBAL_SETTINGS', () => {
  const action = {
    type: 'CLEAR_ADD_GLOBAL_SETTINGS',
    payload: {
      statusCode: 200
    }
  };
...
it('it should check GET_GLOBAL_SETTING', () => {
  const action = {
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        settingsInvoicegetSucesscode: 0,
         settingGlobalAddStatusCode:0,
    FetchGlobal: ['test','test2'],
  statusCodeForSettingFetch: 200,
  settingsBillsAddTemplateSucesscode: 0,
  settingsBillsTemplateList : [],
  SettingsBilltemplategetsuccessCode : 0,
  SettingsBilltemplategetErrorCode : 0,
...
it('it should check CLEAR_GET_GLOBAL_SETTING', () => {
  const action = {
    type: 'CLEAR_GET_GLOBAL_SETTING',
  };
...
it('it should check ADD-BILLS-TEMPLATE', () => {
  const action = {
    type: 'ADD-BILLS-TEMPLATE',
    payload: {
      statusCode: 200
    }
  };
...
it('it should check CLEAR_ADD_BILLS_TEMPLATE_STATUS_CODE', () => {
  const action = {
    type: 'CLEAR_ADD_BILLS_TEMPLATE_STATUS_CODE',
  };
...
it('it should check GET_TEMPLATELIST', () => {
  const action = {
  ...
  statusCodeForSettingFetch: 0,
  settingsBillsAddTemplateSucesscode: 0,
  settingsBillsTemplateList : ['temp','temp2'],
  SettingsBilltemplategetsuccessCode : 200,
  SettingsBilltemplategetErrorCode : 0,
  });
});
...
it('it should check CLEAR_GET_TEMPLATELIST_STATUS_CODE', () => {
  const action = {
    type: 'CLEAR_GET_TEMPLATELIST_STATUS_CODE',
  };
...
settingsBillsAddTemplateSucesscode: 0,
 ...
 it('it should check ERROR_TEMPLATELIST', () => {
        const action = {
            type: 'ERROR_TEMPLATELIST',
...
settingsBillsAddTemplateSucesscode: 0,
  settingsBillsTemplateList : [],
  SettingsBilltemplategetsuccessCode : 0,
  SettingsBilltemplategetErrorCode : 500,
  });
    });
    ...
    it('it should check CLEAR_ERROR_TEMPLATELIST_STATUS_CODE', () => {
  const action = {
    type: 'CLEAR_ERROR_TEMPLATELIST_STATUS_CODE',
  };
...
it('it should check RECURRINGOFF', () => {
  const action = {
    type: 'RECURRINGOFF',
    payload: {
      statusCode: 200
  ...
  expect(SettingsReducer(initialState, action)).toStrictEqual({
        ...
        settingsInvoicegetErrorStatuscode: 0,
        settingsInvoicegetSucesscode: 0,
        RecurringOffStatusCode:200
  });
});

it('it should check REMOVE_RECURRINGOFF', () => {
  const action = {
    type: 'REMOVE_RECURRINGOFF',
  };

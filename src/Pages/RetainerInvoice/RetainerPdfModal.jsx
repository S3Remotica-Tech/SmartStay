            ...
            <div className="w-[90%] rounded-lg">
              ...
              >
                <div className="p-2 relative rounded-t-lg">
                  <div className="flex flex-col md:flex-row justify-between md:items-start gap-4 px-6">
                    ...
                    <div className="w-full md:flex-1  md:text-left">
                      <p className="text-[12px] break-all">dummy@gmail.com</p>

                      <p className="text-[12px] mt-1">{pdfDetails?.mobile}</p>
                    </div>
                ...
                <div className="text-center -mt-5 pb-0">
                  <h5 className="text-[17px] font-semibold font-gilroy">
                    Retainer Invoice
                  </h5>
                </div>
                  ...
                  <div className="w-full bg-white rounded-b-lg relative">
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-6 px-4 mt-1">
                      <div className="text-[13px] text-[#222] font-gilroy">
                        ...
                        <div className="grid grid-cols-[120px_10px_1fr] mb-1 items-center">
                          <div className="font-semibold text-[12px] text-[#171717]">
                            {/* {pdfDetails?.customerInfo?.floorno} */}
                            G-Floor,103-02(D)
                          </div>
                        </div>
                        <div className="grid grid-cols-[120px_10px_1fr] mb-1 items-center">
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b border-[#E8E8E8]">
                          ...
                          <th className="text-right text-[11px] font-medium text-[#7A7A7A] py-2">
                            AMOUNT
                          </th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="text-right pt-4 text-[13px] text-[#444]">
                            Subtotal
                          </td>
                        ...
                        <tr>
                          <td className="text-right py-2 font-semibold text-[14px]">
                            Total
                          </td>

                          <td className="text-right py-2 font-bold text-[14px]">
                            ₹{" "}
                            {Number(
                              pdfDetails?.invoiceInfo?.subTotal || 0,
                            ).toLocaleString("en-IN")}
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="col-span-12 md:col-span-4 flex flex-col justify-between">
                        ...
                        <div className="flex justify-end">
                          <p className="text-[10px]">Scan Qr for Payment</p>
                        </div>
                        {/* 
      <div className="flex justify-end">
      ...
      */}
                ...
                <div className="px-4 mt-3 mb-2">
                  <p
                    ...
                    style={{ fontFamily: "Gilroy" }}
                  >
                    <span className="font-semibold">T&amp;C :</span> Pay on the
                    date of subscription to avoid the access issues.
                  </p>
                </div>
              </div>
            </div>

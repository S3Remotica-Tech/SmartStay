...
import { ImportCurve, CloseCircle, Call ,Location} from 'iconsax-react';
    ...
    return (
        <div >
            <div className="d-flex justify-content-between align-items-center ps-3">
                ...
                <div>
                    <div className="mb-3">
                        {rowData.BalanceDue === 0 ? <span style={{ backgroundColor: '#D9FFD9', color: '#000', borderRadius: '14px', fontFamily: 'Gilroy', padding: "8px 12px" }}>Paid</span> : <span
...
{isVisible && 
            ...
            >
                    <div className="d-flex justify-content-between ps-5 pe-5 pt-3">
                        <div className="">
                            <div>
                            {/* <img src={rowData.profile ? rowData.profile : 'Nothing profile' } style={{ height: 40, width: 40, }} /> */}
                            </div>
                            <div>
                    ...
                    <Table className="mt-5 mb-1" style={{}}>
              <thead>
                <tr>
...
<div>
  ...
  <div>
    <label style={{ fontSize: 14, fontWeight: 500, color: "#000000", fontFamily: "Gilroy" }}>Pay by: {invoiceData.payment.dueDate}</label>
      ...
      <div className="d-flex justify-content-around mt-5 text-center">
        <div>

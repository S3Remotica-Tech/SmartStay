...
const {
  ...
  const handleSaveTemplate = () => {
    ...
    if (securityDepositReceiptTemplate.isSignatureCustomized) {
      const Signatureverify = !securityDepositReceiptTemplate.receiptSignatureUrl
    ...
    if (securityDepositReceiptTemplate.isMobileCustomized) {
    ...
    if (securityDepositReceiptTemplate.isMailIdCustomized) {
      const emailRegex = /^[a-z0-9._%+-]+@[a-z0-9.-]+\.(com|org|net|in)$/;
    ...
    if (securityDepositReceiptTemplate.typeId && state.login.selectedHostel_Id) {
      // dispatch({
...
dispatch({
        ...
        payload: {
          ...
          templateTypeId: securityDepositReceiptTemplate.typeId,
              ...
              <div className=" text-white  p-2 position-relative" style={{ minHeight: 60, backgroundColor: `rgba(${color.r}, ${color.g}, ${color.b}, ${color.a})` }}>
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex gap-2 mb-2 mb-lg-0">
                    <img src={logoPreview ? logoPreview : receiptLogo} alt="logo" style={{ height: 40, width: 50, borderRadius: '6px' }} />

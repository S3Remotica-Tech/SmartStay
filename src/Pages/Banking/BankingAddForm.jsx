...
function BankingAddForm(props) {
  ...
  const CustomMenuList = (props) => {
    ...
    return (
      <components.MenuList {...props}>
        <div className="max-h-[150px] overflow-y-auto">{children}</div>
  ...
  useEffect(() => {
    if (props.editAddBank && props.editAddBank.bankingId) {
      ...
      if (
        props.editAddBank.accountType === "CASH" ||
        props.editAddBank.accountType === "UPI" ||
        props.editAddBank.accountType === "BANK" ||
      ...
      setCardNo(
        props.editAddBank?.creditCardNumber ||
          props.editAddBank?.debitCardNumber,
      );
        ...
        <Modal.Body className="pb-0">
          {activeTab === "BANK" && (
            <div className="grid grid-cols-12 gap-x-4 gap-y-3">
              ...
              <div className="col-span-12 lg:col-span-6">
                <Form.Group>
                  <Form.Label className="text-sm font-medium text-gray-900 font-gilroy mt-2">
                    Account No <span className="text-red-500 text-xl"> * </span>
                  </Form.Label>
                  <FormControl
                    type="text"
                    id="form-controls"
          ...
          {activeTab === "UPI" && (
            <div className="grid grid-cols-12 gap-x-4 gap-y-3">
              <div className="col-span-12 lg:col-span-6">
                ...
                >
                  <Form.Label className="text-sm font-medium text-gray-900 font-gilroy mt-3">
                    Bank <span className="text-red-500 text-xl">*</span>
                  </Form.Label>
              ...
              <div className="col-span-12 lg:col-span-6">
                <Form.Group>
                  <Form.Label className="text-sm font-medium text-gray-900 font-gilroy mt-3">
                    UPI ID <span className="text-red-500 text-xl"> * </span>
                  </Form.Label>
                  <FormControl
                    type="text"
                    id="form-controls"
          ...
          {activeTab === "CASH" && (
            <div className="grid grid-cols-12 gap-x-4 gap-y-3">
              ...
              <div className="col-span-12 lg:col-span-6">
                <Form.Group>
                  <Form.Label className="text-sm font-medium text-gray-900 font-gilroy mt-4">
                    Description{" "}
                  </Form.Label>
                  <FormControl
                    type="text"

...
//     const popover = (
//         <Popover id="popover-basic"  style={{ maxWidth: '100vh', maxHeight: 'auto', marginBottom: "2px",whiteSpace:"nowrap" }} >
//             <Popover.Body class="p-2" style={{width:"70vh"}}>
...
//     const popovers = (
//         <Popover id="popover-basic" style={{ maxWidth: '100vh', maxHeight: 'auto',whiteSpace:"nowrap" }} >
//             <Popover.Body class="p-2" style={{width:"70vh"}}>
//                 <p class="mb-1" style={{ fontSize: "11px" }}>Invoice added</p>
//                 <p class="mb-1" style={{ fontSize: "11px" }}>Invoice Dhaskshan Sri amount of ₹500.00 created by <strong>SmartStay</strong> <span style={{ color: "#2F74EB" }}> - View Details</span></p>
//             </Popover.Body>
//         </Popover>
//     );
//     //   stepper
...
//                     <button type="button" class="" style={{ fontSize: "12px", backgroundColor: "white", fontWeight: "700", width: "110px", borderRadius: "15px", padding: "2px", border: "1px Solid #2E75EA", height: "30px", color: "#2E75EA" }}><img src={Edits} height="12" width="12" /> Edit</button>
//                     <button type="button" class="ms-2" style={{ fontSize: "12px", fontWeight: "700", backgroundColor: "white", width: "110px", borderRadius: "15px", padding: "2px", border: "1px Solid #2E75EA", height: "30px", color: "#2E75EA" }} ><img src={Plus} height="12" width="12" /> Create Bed</button>
//                 </div>
...
//                                     <button type="button" class="btn btn-light p-1" style={{ color: "#0D99FF", height: "4vh", fontSize: "12px" }}>Delete</button>
//                                 </div>
//                             </div>
...
//                             <img src={Edits} style={{ height: "18px", width: "18px" }} />
//                         </div>
//                         <hr class="m-0 mb-2" />
...
//                         </div>
//                     </div>
//                     <div className="col-lg-1  col-md-12 col-sm-12 col-xs-12 " style={{ width: "5vh" }}>
...
//                                         <td class="justify-content-between"><img src={List} height="20" width="20" /><img class="ms-1" src={Edits} height="20" width="20" /></td>
//                                     </tr>
//                                 ))}
//                             </tbody>
//                         </Table>
...
//                         <div class="row" style={{ marginTop: "10px", paddingTop: "5px", backgroundColor: "" }}>
//                             <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12" style={{ backgroundColor: "" }}>
...
//                                 </div>
//                             </div>
//                             <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12" style={{ backgroundColor: "" }}>
...
//                                         <div>
//                                             <Step sx={{ color: "#2F74EB" }} >
//                                                 <OverlayTrigger  trigger="hover" placement="right" overlay={popovers}>
//                                                     <div class="d-flex justify-content-center align-items-center" style={{ height: "25px", width: "25px", border: "1px solid #2F74EB", borderRadius: "50px" }}>
//                                                         <MapsUgcRoundedIcon style={{ color: "#2F74EB", height: "15px", width: "15px" }} />
//                                                     </div>
//                                                 </OverlayTrigger>

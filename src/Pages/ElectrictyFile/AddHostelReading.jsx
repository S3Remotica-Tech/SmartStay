      ...
      <div className="absolute top-2 right-2 bottom-2 w-full max-w-2xl bg-white rounded-xl shadow-xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 show-scrolls ">
          ...
          <Form.Group className="mt-2">
              ...
              {!editHostelReading && (
                <span className="font-gilroy font-normal text-sm leading-none text-gray-500">
                  ...
                  <span className="text-[#1E45E1] font-gilroy">
                    {
                      state.UsersList?.getRoomReadingList?.hostelReadings[0]
                        ?.lastReading
                    }
                  </span>
                </span>
            ...
            <Form.Control
              className={`mt-2 w-full px-3 py-3 text-sm font-gilroy ${
                currentReading ? "font-semibold" : "font-medium"
              }`}
              type="number"
        ...
        <div className="p-4 flex justify-end">
          <Button
            className="bg-transparent border-0 !text-black !font-gilroy"
            onClick={handleClose}
          >
            Cancel
          </Button>
          <Button
            disabled={loading}
            className="!bg-blue-700 w-[130px] !font-gilroy"

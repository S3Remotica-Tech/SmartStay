...
const handleSubmit = () => {
  if (Name && Phone && Requestid && Roomdetail && Complainttype && Assign && Status &&date) {
      dispatch({ type: 'COMPLIANCE-ADD', payload: { Name: Name, Phone: Phone, Requestid: Requestid, Roomdetail:Roomdetail,Complainttype:Complainttype,Assign:Assign ,Status:Status,date:date} })
      setName('')
      setPhone('')
      setRequestid('')
      setRoomdetail('') 

                    ...
                    <div class="p-2">
                        ...
                        {/* <div class="d-flex justify-content-between"> */}
                        {
                               state.UsersList.hostelList.map(item => {
                                ...
                                <div
                                 className='d-flex justify-content-between flex-1' 
                                 style={{width:"100%"}}>
                                <div>
                                    <h5>{item.Name}</h5>
                                </div>
                                ...
                                <div style={{display:'flex',flexDirection:'row',flexWrap:"wrap"}} class="g-1 justify-content-evenly pt-5 flex-4">

                                    {
                                        Array.from(Array(item.number_Of_Floor), (index, element) => {
                                            console.log("FloorID",index,element);
                                            return (
                                                      <DashBoardRoomsList floorID={element+1} hostel_Id={item.id}/>
                                            )

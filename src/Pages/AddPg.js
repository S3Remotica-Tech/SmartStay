...
console.log("currentItem",currentItem)
  ...
  const handleCreatePayingGuest = () => {
    ...
    if (pgName && MobileNumber && location && countryCode) {
      dispatch({
        type: 'PGLIST', payload: {
          profile: file, name: pgName, phoneNo: MobileNumber, email_Id: email, location: location, id: currentItem.id,
    ...
    >
      <Modal show={show} onHide={handleClose} centered backdrop="static" className="custom-modal-width" >
        ...
        <Modal.Body>
          ...
          <div className='row'>
            <Form.Label style={{ fontSize: 14, color: "#222222", fontFamily: "Gilroy", fontWeight: 500 }}>
              Images <span style={{ color: 'transparent', fontSize: '20px' }}>*</span>
            </Form.Label>
        ...
        <Modal.Footer style={{ border: "none" }}>
          ...
          <Button onClick={handleCreatePayingGuest} className='w-100' style={{ backgroundColor: "#1E45E1", fontWeight: 600, borderRadius: 12, fontSize: 16, fontFamily: "Gilroy", padding: 12 }}>

...
function AdminProfileEdit({ show, handleClose }) {
  ...
  const handleMobileChange = (e) => {
    ...
    if (/^0+$/.test(value)) {
      setErrors((prev) => ({
        ...prev,
        mobile: "Mobile number cannot contain only zeros",
      }));
    } else {
      setErrors((prev) => ({
        ...prev,
          ...
          <div className="flex justify-center mb-2">
            ...
            >
              {previewImage ? (
                ...
                <User size="36" color="#9CA3AF" variant="Bold" />
              )}

              <label
                className={`absolute inset-0 flex items-center justify-center
    bg-black/40 cursor-pointer transition-opacity duration-200
    ${hoverImage ? "opacity-100" : "opacity-0"}`}
          ...
          <div className="mb-2">
            ...
            <input
              ...
              className={`w-full h-[44px] mt-2 px-3  shadow-none rounded-lg border ${
          ...
          <div className="mb-2">
            ...
            <div className="flex mt-2">
              ...
              <input
                ...
                className={`w-full h-[44px] px-3 shadow-none rounded-r-lg border ${
            ...
            {state.createAccount?.profileUpdateMobileError && (
              <ErrorMessage
                message={state.createAccount?.profileUpdateMobileError}
                type="error"
              />
            )}
          </div>
          ...
          <div className="mb-2">
            ...
            {state.createAccount?.profileUpdateEmailError && (
              <ErrorMessage
                message={state.createAccount?.profileUpdateEmailError}
                type="error"
              />
            )}
          </div>
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            ...
            className="h-[44px] px-6 rounded-lg bg-[#1E45E1] text-white text-[14px] font-medium hover:bg-blue-700 transition  disabled:!bg-gray-300 disabled:!text-gray-500 disabled:!cursor-not-allowed disabled:!opacity-70"
          >
            Save
          </button>
        </div>

...
function SettingExpenses() {
  ...
  useEffect(() => {
    if (
      state.Settings.addexpencesStatuscode === 201 ||
      state.Settings.editexpencesStatuscode === 200 ||
      state.Settings.deleteexpencesStatusCode === 200 ||
      state.Settings.editExpencesSubCategoryStatuscode === 200
    ) {
      setShowForm(false);
      setShowSubCategoryForm(false);
      // setFormLoading(false)
    ...
    state.login.selectedHostel_Id,
    state.Settings.editExpencesSubCategoryStatuscode,
    state.Settings.addexpencesStatuscode,
    state.Settings.editexpencesStatuscode,
    state.Settings.deleteexpencesStatusCode,
  ]);
        ...
        >
                    ...
                    <div className="flex items-center gap-[10px] shrink-0">
                      ...
                      <div className="relative">
                        ...
                        {openMenuId === category.categoryId && (
                          <div
                            ref={popupRef}
                            className="absolute right-0 top-6 z-50 w-28 bg-white border rounded shadow-md"
                          >
                            <div
                      ...
                      {category.listSubcategories?.length > 0 ? (
                        category.listSubcategories.map((sub) => (
                          <li
                            ...
                            onMouseEnter={() =>
                              setHoveredSubId(sub.subCategoryId)
                            }
          ...
          {showSubCategoryForm && (
            <AddSubCategory
              ...
              handleCloseForm={handleCloseSubCategory}
              AddSubCategory={subType}
              editSubCategory={subCategoryDetails}
            />
          )}

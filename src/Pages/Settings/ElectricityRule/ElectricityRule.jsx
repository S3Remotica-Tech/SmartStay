      ...
      <div className="bg-[#F9FAFF] p-3 md:p-3   overflow-y-auto show-scrolls">
          ...
          <div className="grid grid-cols-12 md:grid-cols-12 gap-4 mb-2">
            <div className="bg-white rounded-xl p-3 shadow-sm w-full  md:col-span-8">
              ...
              <p className="text-[14px] text-[#4B4B4B] mt-1 font-medium">
                {selected === "room"
                  ? "Set up room-based electricity billing parameters"
              ...
              <div className="mt-2 border-t pt-2">
                ...
                <input
                  ...
                  className={`w-full h-[40px] px-3 rounded-md outline-none border ${
        ...
        {selected === "flat" && (
          <div className="grid grid-cols-12 md:grid-cols-12 gap-4 mb-2">
            ...
            ${selectedType !== "fixed" ? "bg-gray-100 cursor-not-allowed" : ""}
          `}
                  />
        ...
        {state.Settings.ebRuleError && (
          <ErrorMessage message={state.Settings.ebRuleError} type="error" />
        )}

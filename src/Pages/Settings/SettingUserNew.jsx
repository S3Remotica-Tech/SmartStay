                          ...
                          <td className="border-b border-gray-200 p-0 text-left align-middle">
                            ...
                            >
                              <PiDotsThreeOutlineVerticalFill
                                className={`h-[20px] w-[20px] rotate-90 cursor-pointer ${
                                  showDots === index
                                    ? "text-[#1E45E1]"
                                    : "text-gray-500"
                                }`}
                              ...
                              {showDots === index && (
                                ...
                                >
                                  <div>
                                    <div
                                      onClick={() =>
                                        canUpdateUser && handleEditForm(item)
                                      }
                                    ...
                                    <div
                                      onClick={() =>
                                        canDeleteUser && handleDeleteForm(item)
                                      }
                                      className={`flex items-center gap-2 px-3 py-2 rounded-b-lg transition ${
                                        canDeleteUser

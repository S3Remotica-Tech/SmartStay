...
function PayingHostel(props) {
    ...
    return (<>
                            ...
                            >
                                ...
                                >
                                    ...
                                    {showDots  && <>
                                        ...
                                        <div ref={popupRef} className= "pg-card"  style={{ cursor: "pointer", backgroundColor: "#F9F9F9", position: "absolute", right: 40, top:-20, width: 120, height: 92, border: "1px solid #EBEBEB", borderRadius: 10, display: "flex", justifyContent: "start", padding: 15, alignItems: "center" }}>
                                            <div >
        ...
        {show &&
            <Modal show={show} onHide={handleClose} centered backdrop="static"  dialogClassName="custom-delete-modal">
                <Modal.Header style={{
                    borderBottom: "none",

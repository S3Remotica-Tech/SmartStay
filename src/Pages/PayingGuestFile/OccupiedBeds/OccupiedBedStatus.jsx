  ...
  return (
              ...
              <div className="flex justify-between w-full p-2 pr-3">
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    <span className="text-sm font-medium text-blue-700 font-gilroy">
                      |
                    </span>
                    <label className="text-sm font-semibold text-blue-700 !font-gilroy">
    ...
    `}
          ...
          `}
                              ...
                              <div
                                onClick={() =>
                                  canUpdatePayingGuests && handleEditBed()
                                }
                  ...
                  <div key={index} className="mb-2">
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="mt-2">
                          ...
                          <label className="text-[16px] font-gilroy font-medium text-[#4B4B4B]">
                            {tenant?.mobile
                              ? `+ ${tenant?.countryCode} ${tenant?.mobile}`
                              : "No phone"}
                          </label>
                        </div>
                      </div>
                      ...
                      <div
                        ...
                        className={`relative w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center cursor-pointer ${
                      ...
                      >
                        ...
                        {activeRoomIdReserved === index && (
                          ...
                          >
                            ...
                            <div
                              className={`flex gap-2 items-center p-2 rounded-b-lg ${
                                canReadBooking
                                  ? "cursor-pointer opacity-100 hover:bg-[#FFF3F3]"
                                  : "cursor-not-allowed opacity-50"
                              }`}
                              onClick={() =>
                                canReadBooking && handleMakeInActive(tenant)
                              }
                            >
                              <LogoutCurve
                                size={18}
                              ...
                              />
                              <label
                                className={`text-[14px] font-gilroy font-medium mb-0 ${canReadBooking ? "text-[#222222]" : "text-gray-300"}`}
                              >
                                Make as Inactive
                              </label>
                            </div>
                            ...
                            >
                              <Edit
                                size={16}
                                color={
                                  canUpdatePayingGuests ? "#1E45E1" : "#888888"
                                }
                                className="ml-1.5"
                              />
                              <label
                                className={`text-[14px] font-gilroy font-medium mb-0 ${canUpdatePayingGuests ? "text-[#222222]" : "text-gray-400"}`}
                              >
                                Edit
                              </label>
                            </div>
                    ...
                    <div className="flex justify-between mt-2 mb-2">
                      ...
                      <label className="font-gilroy text-sm text-gray-800 font-bold">

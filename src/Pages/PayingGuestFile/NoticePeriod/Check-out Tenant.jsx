...
// import Profileimage from "/src/Assets/Images/New_images/profile-picture.png";


// function CheckoutTenant({show , handleClose ,
//   currentItem,customer_details
// }) {
...
// function TenantCheckout({ show , handleClose ,
//   currentItem}) {
...
//     //  console.log("customer_details",customer)
...
//         }, 500);
//     }, [state.UsersList.statusCodegetConfirmCheckout,currentItem]);
...
//         const formattedRequestDate = moment(currentItem.req_date, 'YYYY-MM-DD');
...
//                             id: currentItem?.ID,
//                             hostel_id: currentItem?.Hostel_Id,
//                             comments: comments,
...
//                                     <Image
//                                         src={
//                                             currentItem?.user_profile !== undefined &&
//                                                 currentItem?.user_profile !== null &&
//                                                 currentItem?.user_profile !== '' &&
//                                                 currentItem?.user_profile !== '0'
//                                                 ? currentItem.user_profile
//                                                 : Profile2
//                                         }
...
import dayjs from 'dayjs';
import { CloseCircle, DocumentDownload } from "iconsax-react";
import addcircle from "/src/Assets/Images/New_images/add-circle.png";
import { Trash } from 'iconsax-react';
import Profile2 from "../../../Assets/Images/New_images/profile-picture.png";
import { FaCheck } from "react-icons/fa";

function CheckoutTenant({ show, handleClose, data, customerDetails }) {
  ...
  console.log("advanceAmount", advanceAmount, state.UsersList.GetconfirmcheckoutUserDetails);

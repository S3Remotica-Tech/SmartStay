...
//           <button type="button" onClick={handleShow} style={{ backgroundColor: "white", fontSize: "12px", fontWeight: "700", width: "150px", borderRadius: "15px", padding: "2px", border: "1px Solid #2E75EA", height: "30px", color: "#2E75EA" }} ><img src={Plus} class="me-1" height="12" width="12" alt="Plus" />Add User</button>
...
{/* {
  <div>{state.UsersList.addUser?.message?.length > 0 ? <label style={{ color: "red", fontSize: 18 }}>{state.UsersList.addUser.message}</label> : null}</div>
} */}
                <div className='container' style={{ marginTop: "30px" }}>
                  <div className='row'>
                    <div className='col lg-6'>
                  ...
                  <div className='row'>
                    <div className='col lg-6'>
                      <Form.Group className="mb-3">
                        ...
                        <FormControl
                          type="text"
                          value={userList.Phone} onChange={(e) => { setUserList({ ...userList, Phone: e.target.value }) }}
                          style={bottomBorderStyle}
                        />
                      </Form.Group>
                    </div>
                  ...
                  <div className='row'>
                    <div className='col lg-12'>
                      ...
                      <Form.Select aria-label="Default select example"
                        style={bottomBorderStyle} value={userList.hostel_Id} onChange={(e) => { setUserList({ ...userList, hostel_Id: e.target.value }) }}>
                  ...
                  <div className='row mt-2'>
                    <div className='col lg-4'>
                      <Form.Label style={{ fontSize: "12px" }}>Select Floor</Form.Label>
                      <Form.Select aria-label="Default select example"
                        style={bottomBorderStyle} value={userList.Floor} onChange={(e) => { setUserList({ ...userList, Floor: e.target.value }) }}>
                        <option>Selected Floor</option>
                        {
                          state.UsersList?.Users?.map((item) => {
                            return (
                              <>

                                <option>{item.Floor}</option>
                              </>
                            )
                          })
                        }
                    ...
                    <div className='col lg-4'>
                      <Form.Label style={{ fontSize: "12px" }}>Select Room</Form.Label>
                      <Form.Select aria-label="Default select example"
                        style={bottomBorderStyle} value={userList.Rooms} onChange={(e) => { setUserList({ ...userList, Rooms: e.target.value }) }}>
                    ...
                    <div className='col lg-4'>
                      <Form.Label style={{ fontSize: "12px" }}>Select Bed</Form.Label>
                      <Form.Select aria-label="Default select example" 
                        style={bottomBorderStyle} value={userList.bed} onChange={(e) => { setUserList({ ...userList, bed: e.target.value }) }}>
                  ...
                  <div className='row'>
                    <div className='col lg-6'>
                      <Form.Group className="mb-3">
                        ...
                        <FormControl
                          type="text"
                          value={userList.AdvanceAmount} onChange={(e) => { setUserList({ ...userList, AdvanceAmount: e.target.value }) }}
                          style={bottomBorderStyle}
                        />
                      </Form.Group>
                    </div>
                    ...
                    <div className='col lg-6'>
                      <Form.Group className="mb-3">
                        ...
                        <FormControl
                          type="text"
                          value={userList.RoomRent} onChange={(e) => { setUserList({ ...userList, RoomRent: e.target.value }) }}
                          style={bottomBorderStyle}
                        />
                      </Form.Group>
                    </div>
                  ...
                  <div className='row'>
                    <div className='col lg-6'>
                      <Form.Group className="mb-3">
                        ...
                        <FormControl
                          type="text"
                          value={userList.PaymentType} onChange={(e) => { setUserList({ ...userList, PaymentType: e.target.value }) }}
                          style={bottomBorderStyle}
                        />
                      </Form.Group>
                    </div>
                    ...
                    <div className='col lg-6'>
                      <Form.Group className="mb-3">
                        ...
                        <FormControl
                          type="text"
                          value={userList.BalanceDue} onChange={(e) => { setUserList({ ...userList, BalanceDue: e.target.value }) }}
                          style={bottomBorderStyle}
                        />
                      </Form.Group>
                    </div>

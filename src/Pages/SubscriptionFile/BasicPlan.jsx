...
function SubscriptionCard() {
  ...
  return (
    <div className="mt-4 mb-12 max-h-[500px] overflow-y-auto font-gilroy show-scrolls">
        ...
        <div className="grid grid-cols-3 mt-2 gap-4">
          <div className="flex gap-2 items-start">
            ...
            <div>
              ...
              <p className="text-[16px] text-[#4B4B4B]">Oct 21, 2025</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 items-start">
            ...
            <div>
              ...
              <p className="text-[16px] text-[#4B4B4B]">UPI Auto Debit</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 items-start">
            ...
            <div>
              ...
              <p className="text-[16px] text-[#1E45E1]">Active</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4">
        <div className="max-h-[200px] overflow-y-auto border-t border-[#E8E8E8]">
          <table className="w-full text-sm text-[#222]">
            <thead className="sticky top-0 bg-[#E7F1FF] text-[12px] text-[#939393] z-10">
              <tr className="h-8">

...
console.log("tabName",tabName)
 const hostelId = state.login?.selectedHostel_Id;
  ...
  return (
    <div
      className="container mt-4 show-scroll p-0 "
      style={{
        fontFamily: "Gilroy",
        maxHeight: "500px",
        overflowY: "auto",
    ...
    >
          ...
          <div className="d-flex gap-3 mb-3">
            <div>
              <div>
                <label
                  className=""
                  style={{ fontWeight: 600, color: "#222222", fontSize: 16 }}
                >
              ...
              <div>
                <label
                  style={{ fontWeight: 500, color: "#4A4A4A", fontSize: 14 }}
                >
                  ₹999/month
                </label>
              </div>
            ...
            <div className="bg-[#00A32E] text-white px-3 h-fit py-1 rounded-xl text-[12px] font-medium w-max text-center flex items-center gap-2">
              <TbCheck /> Active
            </div>
          </div>
          <div className="">
            <Button  onClick={() => handleNavigatePlan("allplans")}
              className=""
              style={{
                background: "#1E45E1",
                borderRadius: "10px",
          ...
          <Col>
            <div className="d-flex gap-2 align-items-start">
              ...
              <div className="">
                <div>
                  <label
                    style={{ fontWeight: 400, color: "#4B4B4B", fontSize: 13 }}
                  >
                    Renewal Date
                  </label>
                </div>
                <div>
                  <label
                    className=""
                    style={{ fontWeight: 400, color: "#4B4B4B", fontSize: 16 }}
                  >
                    Oct 21, 2025
                  </label>
                </div>
            ...
            <div className="d-flex gap-2 align-items-start">
              ...
              <div className="">
                ...
                <div>
                  <label
                    className=""
                    style={{ fontWeight: 400, color: "#1E45E1", fontSize: 16 }}
                  >
                    Active
                  </label>
                </div>
      ...
      <h5
        className="mt-4 mb-3"
        style={{ color: "#222222", fontWeight: 600, fontSize: 16 }}
      >
        Billing History
      </h5>

      <div className="col-lg-12 col-md-12 col-sm-10 mt-3">
        <div className="  me-2" style={{ paddingBottom: "20px" }}>
          <div

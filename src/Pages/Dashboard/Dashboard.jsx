  ...
  const dashboardCards = [
    {
      ...
      stats: [
        ...
        {
          label: "Total Beds",
          value1: `${dashboardList?.roomsBeds?.totalBeds || "0"}`,
        },
      ],
    ...
    },
    {
      ...
      stats: [
        {
          label: "Occupied Beds",
          value1: `${dashboardList?.occupancy?.occupiedBeds || "0"}`,
          valueColor: "text-green-600",
        },
        {
          label: "Available Beds",
          value1: `${dashboardList?.occupancy?.availableBeds || "0"}`,
    ...
    },
    {
      ...
      stats: [
        {
          label: "Total Tenants",
          value1: `${dashboardList?.tenantsSummary?.totalTenants || "0"}`,
        },
        {
          label: "Check-in Tenants",
          value1: `${dashboardList?.tenantsSummary?.checkInTenants || "0"}`,
          valueColor: "text-green-600",
        },
      ],
    ...
    },
    {
      ...
      stats: [
        {
          label: "Total Advance",
          value1: `₹ ${dashboardList?.advanceSummary?.totalAdvance || "0"}`,
        },
        {
          label: "Advance Holding",
          value1: `₹ ${dashboardList?.advanceSummary?.advanceHolding || "0"}`,
        },
...
`}
              ...
              <div className="max-h-[calc(100vh-120px)] overflow-y-auto relative">
                {loading && (
                  <div className="!absolute !inset-0 !flex !items-center !justify-center !bg-transparent !z-10">
                    <div className="!w-10 !h-10 !border-[4px] !border-blue-700 !border-t-transparent !rounded-full animate-spin"></div>
                  </div>
                )}
      ...
      `}
                        ...
                        <div className="space-y-2">
                          {card.stats.map((stat, index) => (
                            ...
                            >
                              ...
                              <span
                                className={`font-semibold font-[Gilroy] whitespace-nowrap text-xl ${
                                  stat.valueColor || "text-[#737373]"
                                }`}
                              >
                                {stat?.value1}
                                {stat?.value2 && (
                          ...
                          <div className="mt-3 pt-3 border-t text-xs text-gray-500  font-[Gilroy]">
                            <div className="flex items-center justify-between mb-2">
                                    ...
                                    >
                                      <div className="w-fit bg-white rounded-xl shadow-lg border p-3">
                                        ...
                                        <div className="space-y-4 overflow-y-auto max-h-[220px] show-scrolls">
                                          {dashboardList?.roomsBeds?.sharingInfo?.map(
                                            (item, index) => (
                                              <div
                                                key={index}
                                              ...
                                              >
                                                ...
                                                <div className="flex justify-between text-sm whitespace-nowrap border-t pb-1 pt-1 space-x-8">
                                                  <div className="gap-1">
                                                    <div className="text-[#6A7282] font-semibold text-xs">
                                                      Rooms
                                                    </div>
                              ...
                              {card.title === "Advance Holding" && (
                                <span className="text-[#00A63E] font-[Gilroy] font-semibold text-sm whitespace-nowrap">
                                  ₹{" "}
                                  {dashboardList?.advanceSummary
                                    ?.otherDeduction || 0}
                                </span>
                              )}
                            ...
                            <div
                              className={`space-y-2 ${
                                card?.sharingData?.length > 0
                                  ? "max-h-[100px] overflow-y-auto show-scrolls"
                                  : ""
                              }`}
                            >
                              {card?.sharingData?.length > 0
                                ? card?.sharingData?.map((item, index) => (
                                    <div
                                      key={index}
                                      className="flex items-center gap-3 me-3 "
                                    >
          ...
          {activeTab === "2" && <DashboardAnnouncement />}
          {activeTab === "3" && <DashboardUpdates />}
        </div>
      </div>
    </>
  );

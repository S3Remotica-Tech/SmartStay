...
function DashboardAnnouncement() {
  ...
  //     dispatch({
  //       type: "CREATECOMMENTS",
  //       payload: { an_id: selectedCard, comment: Comments },
  //     });
  //   }
  //   setComments("");
  //   setCommentsList([]);
  ...
  // useEffect(() => {
  //   if (
  //     state.PgList.statuscodeForAddAnnouncement === 200 ||
  //     state.PgList?.deleteAnnounmentSuccessStatus === 200
  //   ) {
  ...
  //   state.PgList?.deleteAnnounmentSuccessStatus,
  // ]);
  ...
  // useEffect(() => {
  //   if (state.PgList.TitleAlready !== "" || state.PgList.TittleUnique !== "") {
  //     // setFormLoading(false);
  //   }

...
DeleteTenantDocument.propTypes = {
  showDeleteDoc: PropTypes.bool.isRequired,
  handleDeleteDocumentClose: PropTypes.func.isRequired,
  showDocumentId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

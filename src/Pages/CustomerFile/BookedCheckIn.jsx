    ...
    return (
        ...
        >
            ...
            <Modal.Dialog className="m-0 p-0 max-w-4xl pr-2.5 rounded-3xl font-gilroy">
                ...
                <Modal.Body className="p-0 mx-2">

                    <div className="flex flex-col max-h-[90vh]">
                        <Modal.Header className="pt-4 relative border-0" >
        ...
        ${activeTab === "SHORT"
                        ...
                        {activeTab === "LONG" ? <>
                            {/* <div className="show-scroll p-2 mt-2 me-1 max-h-64 overflow-y-auto"> */}
                             <div className="flex-1 overflow-y-auto show-scroll p-2 mt-2 me-1">
                            ...
                            <Button
                                className="mb-3 w-full h-12 mt-2 !rounded-[10px] !bg-[#1E45E1] text-white !text-lg !font-semibold font-gilroy"
                                disabled={
                                    state.UsersList.bedError ||
                                    formLoading ||

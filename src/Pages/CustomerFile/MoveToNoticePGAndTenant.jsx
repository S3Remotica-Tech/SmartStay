...
function MoveToNoticePGAndTenant(props) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute top-2 right-2 bottom-2 w-full max-w-2xl bg-white rounded-xl shadow-xl flex flex-col">
        ...
        <div className="relative px-4 py-1  flex-1 overflow-y-auto">
          {formLoading && (
                ...
                <div className="relative w-full mt-1">
                  <DatePicker
                    ...
                    disabledDate={(current) => {
                      ...
                      return (
                        current && current.isBefore(dayjs(requestDate), "day")
                      );
                    }}
                    getPopupContainer={() => document.body}
                    popupStyle={{
...
MoveToNoticePGAndTenant.propTypes = {

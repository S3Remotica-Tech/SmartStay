...
function DeleteDraftTenant({ open, onClose, deleteTenantId }) {
  ...
  const handleConfirmDelete = () => {
    if (deleteTenantId) {
      ...
      dispatch({
        type: "DELETE_DRAFT_TENANT_SAGA",
        payload: {
          customerId: deleteTenantId,
...
DeleteDraftTenant.propTypes = {
  open: PropTypes.bool,
  onClose: PropTypes.func,
  deleteTenantId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
export default DeleteDraftTenant;

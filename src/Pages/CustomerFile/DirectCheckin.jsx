...
import { InfoCircle, ArrowRight2, Edit2 } from "iconsax-react";
                    ...
                    <div className="">
                      ...
                      <div className="">
                        <button
                          ...
                          className="flex items-center justify-center w-full gap-1.5 bg-[#EAEEFF]   border-1 border-[#EAEEFF]
                        disabled:bg-gray-100 disabled:text-gray-500
                        disabled:cursor-not-allowed 
                        text-[#1E45E1] font-gilroy font-semibold text-sm rounded-lg px-4 py-2 mb-2.5"
                        >
                          <AddCircle
                      ...
                      {fields.map((item, index) => {
                        ...
                        return (
                          <div className="flex gap-3 mb-3 px-2" key={index}>

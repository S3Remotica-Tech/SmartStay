                      ...
                      <div className="col-12 mb-1">
                        ...
                        <Select
                          ...
                          options={
                            Floor
                              ? state.UsersList?.roomdetails
                                ?.filter((item) => String(item.Floor_Id) === String(Floor))
                                ?.map((item) => ({
                                  value: item.Room_Id,
                                  label: item.Room_Name,
                                })) || []
                              : []   // If no floor selected → no rooms
                          }
                          ...
                          value={
                            Floor && Rooms
                              ? {
                                ...
                                label: state.UsersList?.roomdetails?.find(
                                  (option) =>
                                    String(option.Room_Id) === String(Rooms) &&
                                    String(option.Floor_Id) === String(Floor)
                                )?.Room_Name,
                              }
                              : null
                          }
  ...
  {internalError && (
                        ...
                        <div className="d-flex justify-content-end mt-3">
                          ...
                          <Button style={{
                            ...
                            width: "146px",
                            whiteSpace: "nowrap", marginLeft: 10, marginRight: 10
                          }} onClick={handleCreateCustomer}>Create Customer</Button>

...
function BankTransactionRegister() {
  ...
  const stats = [
    ...
    { title: "Total Debits", value: "₹61,500", up: "12%" },
    { title: "Net Balance", value: "₹19,500", up: "8%", link: true },
    { title: "Unmapped Transactions", value: "7", link: true },
  ];
        ...
        <div className='flex items-center gap-2'>
          ...
          <div>
            ...
            <label className="text-sm font-normal text-[#4A5565]">
              Reports / Bank Transaction Register
            </label>
          </div>
        </div>

            ...
            <div className="px-1 pb-1 bg-[#F9FAFB] rounded-lg h-full flex flex-col overflow-hidden">
                ...
                <div className="bg-white mt-4 rounded-xl shadow-sm border border-[#E8E8E8] ms-1 me-1 flex-1 overflow-hidden">
                    ...
                    <div className="h-full overflow-auto ">
                        <table className="w-full table-fixed text-[12px] font-gilroy">

                            <thead className="bg-[#F9FAFB] text-[#6B7280] sticky top-0 z-10">
                                <tr className="border-b border-[#E8E8E8]">


                                    <th className="px-4 py-2.5 text-left font-semibold w-[40px]">
                                        <Setting3
                                    ...
                                    <th className="px-4 py-2.5 text-left font-semibold w-[140px]">
                                        INVOICE NO
                                    </th>


                                    <th className="px-4 py-2.5 text-left font-semibold w-[160px]">
                                        NAME
                                    </th>


                                    <th className="px-4 py-2.5 text-center font-semibold w-[110px]">
                                    ...
                                    <th className="px-4 py-2.5 text-center font-semibold w-[130px]">
                                        INVOICE DATE
                                    </th>
                                    ...
                                    <th className="px-4 py-2.5 text-center font-semibold w-[100px]">
                                        <div className="flex justify-center items-center gap-1">
                                            AMOUNT
                                            <ArrowSwapVertical size="16" color="#4B4B4B" />
                                        </div>
                                    ...
                                    <th className="px-4 py-2.5 text-center font-semibold w-[70px]">
                                        STATUS
                                    </th>
                            ...
                            <tbody>
                                {invoices.map((row, i) => (
                                    ...
                                    >
                                        <td></td>
                                        <td
                                            className="px-4 py-3 text-[#1E45E1] font-semibold truncate whitespace-nowrap"
                                            title={row.no}
                                        >
                                            {row.no}
                                        </td>

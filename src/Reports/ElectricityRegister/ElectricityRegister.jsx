        ...
        <div className='flex items-center gap-2'>
          ...
          <div>
            <div className='flex items-center gap-2 relative w-fit' onClick={() => setRegister(!register)}>
              <h1 className="text-lg font-semibold my-0 text-[#222222]">Electricity Billing Register</h1>
            ...
            <label className="text-sm font-normal text-[#4A5565]">
              Reports / Electricity Billing Register
            </label>
          </div>
        </div>
...
export default ElectricityRegister
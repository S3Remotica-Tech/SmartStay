...
import { ArrowLeft, ArrowDown2, Calendar, ArrowUp2 } from "iconsax-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4  bg-[#FAFAFA] ">
          {amountCards.map((card) => (
            ...
            >
              ...
              <div
                className={`text-xl font-semibold ${card.textColor ?? "text-gray-900"}`}
              >
                {card.amount}
              </div>
              ...
              {card.percent !== undefined && (
                <>
                  <div
                    className={`mt-3 h-2 w-full rounded-full ${card.barBg} overflow-hidden`}
                  >
                    <div
              ...
              {card.note && (
                <div className="mt-3 text-xs text-gray-500">{card.note}</div>
              )}
            </div>
          ))}
        </div>
        ...
        <div className="rounded-xl border border-[#E5E7EB]  p-3 lg:col-span-7 mt-3 ]">
          <div className="flex justify-between items-center mb-2">
            <div>
              ...
              <label className="font-normal text-[#4A5565] font-[Gilroy] text-sm">
                Collected vs outstanding amounts for current month
              </label>
            </div>

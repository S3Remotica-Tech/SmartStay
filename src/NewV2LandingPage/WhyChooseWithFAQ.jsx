...
function WhyChooseWithFAQ() {
    ...
    return (
        <div>
            ...
            <div className={`w-full h-[1000px]  bg-[#1A1A1A] text-[#FFFFFF] py-10 px-[70px] relative`}>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center px-[70px]">
                    ...
                    <div>
                        ...
                        <p className={`text-[#FFFFFF] mt-4 max-w-md text-xl font-tasa font-normal`}>
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            {features.map((item, index) => (
                                <div key={index} className="flex items-center gap-3">
                                    ...
                                    <label className={` text-[#FFFFFF] text-sm font-semibold font-tasa`}>
                                        {item}
                                    </label>
                                </div>
                            ))}
                    ...
                    <div className="relative flex justify-center">
                        <img
                            src={Phone}
                            className="w-[460px] relative z-10"
                        />
                ...
                <div className="mx-auto absolute bottom-[-150px]  left-[70px] right-[70px] max-w-8xl   bg-[#F6F9FF] 
                p-4 rounded-xl font-tasa items-start">
                    <h2 className="text-center text-4xl font-semibold mb-4 text-[#16151C]">
                        Frequently Asked Questions
                    </h2>
                    <div className="mx-auto grid md:grid-cols-2 gap-6 bg-[#F6F9FF]  

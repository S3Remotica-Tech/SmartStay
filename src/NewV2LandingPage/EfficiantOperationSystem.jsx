  ...
  return (
    <div className="w-full py-[30px] md:py-[40px] px-[20px] md:px-[101px] font-tasa bg-[#1A1A1A] mt-20">
      <div className="max-w-[1200px] mx-auto text-center rounded-2xl">
        <div
          className="inline-flex items-center gap-2 bg-[#F6F6F64D] border border-[#F6F6F64D] 
          ...
          {features.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="feature-card bg-white mx-auto grid md:grid-cols-10 items-center
                ...
                {index % 2 === 0 && (
                  <div className="md:col-span-4 flex justify-center items-center overflow-hidden h-[200px]">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="w-full max-w-[260px] md:max-w-[320px] transition-transform duration-75 object-contain"
                    />
                  </div>
                )}
              </motion.div>
...
export default EfficientOperationSystem;
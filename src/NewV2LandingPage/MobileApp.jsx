  ...
  return (
    <div className="w-full bg-[#2A2A2A] py-[40px] md:py-[53px] px-[20px] md:px-[101px] font-tasa">
      ...
      <div className="bg-white mb-4  mx-auto grid md:grid-cols-10 items-center border border-gray-200 rounded-lg p-4 md:p-8 gap-10">
        <div className="w-full md:col-span-6 flex items-start self-start ">
          <div>
            ...
            <p className="text-[#2D2D2D] mt-4 max-w-md text-base md:text-xl font-normal">
              Your complete hostel dashboard, now in your pocket. Track rent
              collections, monitor occupancy, manage complaints, and view
              reports instantly — even while traveling.
            </p>
        ...
        >
          <img alt="image" src={IPhone} className="" />
        </div>
      </div>
      ...
      <div className="bg-white mb-4 mx-auto grid md:grid-cols-10 items-center border border-gray-200 rounded-lg p-4 md:p-8 gap-10">
        <div
          ...
          style={{ backgroundImage: `url(${Nature})` }}
        >
          <img alt="image" src={MobMock} className="" />
        </div>
        ...
        <div className="w-full md:col-span-6 flex items-start self-start ">
          <div>
            ...
            <p className="text-[#2D2D2D] mt-4 max-w-md text-base md:text-xl font-normal">
              Everything tenants need, in one simple app. Pay rent online, raise
              complaints, and receive important updates without visiting the
              office.
            </p>

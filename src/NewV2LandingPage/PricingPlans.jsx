  ...
  return (
    <div className="w-screen h-auto  bg-white font-tasa">
      <div className=" mx-auto text-center px-[120px] py-16 h-auto animate-[fadeUp_0.6s_ease-out]">
        <div
          className="inline-flex items-center gap-2 bg-[#F4F6FF] shadow-sm border border-blue-[#F4F6FF] 
      ...
      `}
            >
              <div className=" relative">
                <h3 className="text-center text-xl font-semibold text-[#222222] uppercase ">
                  {plan.name}
                </h3>
                {plan.popular && (
              ...
              <div className="text-start">
                <label className="text-sm text-[#4B4B4B] text-medium mt-3">
                  {plan.text}{" "}
                </label>
              </div>
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center gap-2 text-sm ${
                          isDisabled ? "text-gray-400" : "text-[#1D2127]"
                        }`}
                      >
                        <TickSquare
                          size="14"

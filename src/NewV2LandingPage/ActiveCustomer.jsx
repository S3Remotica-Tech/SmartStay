  ...
  return (
    <div className="w-full bg-[#FDFDFD] py-12 px-[150px]">
      <p className="text-center text-[#061C3D] text-lg 2xl:text-xl mb-6 font-semibold font-gilroy">
        Over{" "}
        <span className="text-blue-600 font-semibold font-gilroy italic">
          1,000+
        </span>{" "}
        actively paying customers
      </p>
      ...
      <Marquee speed={100} pauseOnHover={true} gradient={false}>
        <img
          alt="image"
          src={axn}
          className="h-8 mx-10 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition"
        />
        <img
          alt="image"
          src={lenovo}

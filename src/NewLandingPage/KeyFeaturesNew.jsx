            ...
            >
              {[
                ...
                <div
                  ...
                  className={`feature-button ${activeSection === feature.value ? "active" : ""
                    }`}
      ...
      >
        ...
        >
          ...
          <div style={{ flex: "1 1 500px", paddingRight: "10px" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, fontFamily: "Montserrat", color: "#090F29", fontSize: 18, fontWeight: 600 }}>
              {[
                "Auto-generate rent & utility invoices monthly",
                "One-click payment via UPI, QR or bank transfer",
                "Real-time payment status tracking for Managers",
                "Instant receipts with GST and components split",
              ].map((item, index) => (
                <li
                  key={index}
                  style={{

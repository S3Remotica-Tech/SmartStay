...
const HomePage = () => {
  ...
  const SEO = {
    title: "SmartStay PG & Hostel Management Software",
    description: "India’s most trusted hostel software. SmartStay offers rent collection tools, tenant billing, PG booking system, and a complete hostel issue tracking tool.",
    url: "https://smartstay.qbatz.com/",
    image: "https://smartstay.qbatz.com/assets/sm_homepage-CODs4gRc.png",
    imageAlt: "SmartStay dashboard showing hostel room availability and bed occupancy"
  };
  return (
